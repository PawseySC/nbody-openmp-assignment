...
obj/common_c.o : src/common.h src/common.c 
	$(CC) $(COMMONFLAGS) $(CFLAGS) $(OMP_FLAGS) -c src/common.c -o obj/common_c.o
...
bin/01_nbody_cpu_serial_c : src/common.h src/01_nbody_cpu_serial.c obj/common_c.o
	...
	$(CC) $(COMMONFLAGS) $(CFLAGS) $(OMP_FLAGS) -o bin/01_nbody_cpu_serial_c obj/01_nbody_cpu_serial_c.o obj/common_c.o

# fortran openmp codes
bin/02_nbody_cpu_openmp_loop : src/02_nbody_cpu_openmp_loop.f90 obj/common.o
...
bin/02_nbody_cpu_openmp_task : src/02_nbody_cpu_openmp_task.f90 obj/common.o
...
bin/02_nbody_cpu_openmp_loop_c : src/common.h src/02_nbody_cpu_openmp_loop.c obj/common_c.o
...
bin/02_nbody_cpu_openmp_task_c : src/common.h src/02_nbody_cpu_openmp_task.c obj/common_c.o
